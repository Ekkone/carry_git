...
/**
  ...
  ** 				 kd ：
	...
	**************************************************************
**/
static void pid_reset(pid_t	*pid, float kp, float ki, float kd,float e_max,float ec_max)
{
    pid->p = kp;
    pid->i = ki;
    pid->d = kd;
                      ...
                      float ec_max)
{
    ...
    /*init pid param */
    pid->f_param_init(pid, mode, maxout, intergral_limit, kp, ki, kd,e_max,ec_max);	
}
